...
#define OPTIONS_BUTTON_MODE_COUNT 2
...
#define OPTIONS_TRAINER_BATTLE_MODE_MIXED  0
#define OPTIONS_TRAINER_BATTLE_MODE_SINGLE 1
#define OPTIONS_TRAINER_BATTLE_MODE_DOUBLE 2
#define OPTIONS_TRAINER_BATTLE_MODE_COUNT  3

#define OPTIONS_BATTLE_SCENE_1X 0
#define OPTIONS_BATTLE_SCENE_OFF 1
#define OPTIONS_BATTLE_SCENE_2X 2
#define OPTIONS_BATTLE_SCENE_3X 3
#define OPTIONS_BATTLE_SCENE_4X 4

#define OPTIONS_POKEMON_FOLLOWER_ON  0
#define OPTIONS_POKEMON_FOLLOWER_OFF 1
#define OPTIONS_POKEMON_FOLLOWER_COUNT 2
