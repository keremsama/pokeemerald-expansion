...
#define SWSH_ITEM_MENU_PARTY_PANEL      (SWSH_ITEM_MENU && TRUE)                // Show Pokémon party panel on the left side of the bag
...
#define SWSH_ITEM_MENU_IN_BATTLE_USE    (SWSH_ITEM_MENU_IN_BAG_USE && FALSE)    // Use items in bag during battle (skip party menu)
#define SWSH_ITEM_MENU_PARTY_HP_BAR     (SWSH_ITEM_MENU_IN_BAG_USE && TRUE)     // Show HP bar in party slot for certain items usage

#define SWSH_ITEM_MENU_PYRAMID          (SWSH_ITEM_MENU && FALSE)                // Use SwSh bag menu for the Battle Pyramid
