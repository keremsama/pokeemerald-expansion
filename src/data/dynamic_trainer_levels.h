...
// SPECIAL TRAINERS
DYNAMIC_TRAINER_LEVEL(TRAINER_CYNTHIA, 100)

// ELITE FOUR
DYNAMIC_TRAINER_LEVEL(TRAINER_SIDNEY, 99)
DYNAMIC_TRAINER_LEVEL(TRAINER_PHOEBE, 99)
DYNAMIC_TRAINER_LEVEL(TRAINER_GLACIA, 99)
DYNAMIC_TRAINER_LEVEL(TRAINER_DRAKE, 99)

// MATCH RECALL TRAINERS
