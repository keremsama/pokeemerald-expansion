...
static const u8 *const sScrollableMultichoiceOptions[][MAX_SCROLL_MULTI_LENGTH] =
{
    ...
    {
        COMPOUND_STRING("KISS POSTER{CLEAR_TO 0x5E}11BP"),
        COMPOUND_STRING("KISS CUSHION{CLEAR_TO 0x5E}22BP"),
        COMPOUND_STRING("SMOOCHUM DOLL{CLEAR_TO 0x5E}22BP"),
        COMPOUND_STRING("TOGEPI DOLL{CLEAR_TO 0x5E}33BP"),
        COMPOUND_STRING("MEOWTH DOLL{CLEAR_TO 0x5E}33BP"),
        COMPOUND_STRING("CLEFAIRY DOLL{CLEAR_TO 0x5E}33BP"),
        COMPOUND_STRING("DITTO DOLL{CLEAR_TO 0x5E}33BP"),
        COMPOUND_STRING("CYNDAQUIL DOLL{CLEAR_TO 0x5E}56BP"),
        COMPOUND_STRING("CHIKORITA DOLL{CLEAR_TO 0x5E}56BP"),
        COMPOUND_STRING("TOTODILE DOLL{CLEAR_TO 0x5E}56BP"),
        gText_Exit
    },
    [SCROLL_MULTI_BF_EXCHANGE_CORNER_DECOR_VENDOR_2] =
    {
        COMPOUND_STRING("LAPRAS DOLL{CLEAR_TO 0x58}89BP"),
        COMPOUND_STRING("SNORLAX DOLL{CLEAR_TO 0x58}89BP"),
        COMPOUND_STRING("VENUSAUR DOLL{CLEAR_TO 0x58}179BP"),
        COMPOUND_STRING("CHARIZARD DOLL{CLEAR_TO 0x58}179BP"),
        COMPOUND_STRING("BLASTOISE DOLL{CLEAR_TO 0x58}179BP"),
        gText_Exit
    },
    [SCROLL_MULTI_BF_EXCHANGE_CORNER_VITAMIN_VENDOR] =
    {
        COMPOUND_STRING("EXP. CANDY XS{CLEAR_TO 0x5E}1BP"),
        COMPOUND_STRING("EXP. CANDY S{CLEAR_TO 0x5E}2BP"),
        COMPOUND_STRING("EXP. CANDY M{CLEAR_TO 0x5E}4BP"),
        COMPOUND_STRING("EXP. CANDY L{CLEAR_TO 0x5E}6BP"),
        COMPOUND_STRING("EXP. CANDY XL{CLEAR_TO 0x5E}9BP"),
        COMPOUND_STRING("RARE CANDY{CLEAR_TO 0x58}10BP"),
        gText_Exit
    },
    [SCROLL_MULTI_BF_EXCHANGE_CORNER_HOLD_ITEM_VENDOR] =
    {
        COMPOUND_STRING("LEFTOVERS{CLEAR_TO 0x5E}33BP"),
        COMPOUND_STRING("WHITE HERB{CLEAR_TO 0x5E}22BP"),
        COMPOUND_STRING("QUICK CLAW{CLEAR_TO 0x5E}16BP"),
        COMPOUND_STRING("MENTAL HERB{CLEAR_TO 0x5E}22BP"),
        COMPOUND_STRING("BRIGHTPOWDER{CLEAR_TO 0x5E}22BP"),
        COMPOUND_STRING("CHOICE BAND{CLEAR_TO 0x5E}44BP"),
        COMPOUND_STRING("KING'S ROCK{CLEAR_TO 0x5E}44BP"),
        COMPOUND_STRING("FOCUS BAND{CLEAR_TO 0x5E}44BP"),
        COMPOUND_STRING("SCOPE LENS{CLEAR_TO 0x5E}22BP"),
        gText_Exit
    },
    ...
    {
        COMPOUND_STRING("SOFTBOILED{CLEAR_TO 0x4E}11BP"),
        COMPOUND_STRING("SEISMIC TOSS{CLEAR_TO 0x4E}16BP"),
        COMPOUND_STRING("DREAM EATER{CLEAR_TO 0x4E}16BP"),
        COMPOUND_STRING("MEGA PUNCH{CLEAR_TO 0x4E}16BP"),
        COMPOUND_STRING("MEGA KICK{CLEAR_TO 0x4E}33BP"),
        COMPOUND_STRING("BODY SLAM{CLEAR_TO 0x4E}33BP"),
        COMPOUND_STRING("ROCK SLIDE{CLEAR_TO 0x4E}33BP"),
        COMPOUND_STRING("COUNTER{CLEAR_TO 0x4E}33BP"),
        COMPOUND_STRING("THUNDER WAVE{CLEAR_TO 0x4E}33BP"),
        COMPOUND_STRING("SWORDS DANCE{CLEAR_TO 0x4E}33BP"),
        gText_Exit
    },
    [SCROLL_MULTI_BF_MOVE_TUTOR_2] =
    {
        COMPOUND_STRING("DEFENSE CURL{CLEAR_TO 0x4E}11BP"),
        ...
        COMPOUND_STRING("ICY WIND{CLEAR_TO 0x4E}16BP"),
        COMPOUND_STRING("ENDURE{CLEAR_TO 0x4E}33BP"),
        COMPOUND_STRING("PSYCH UP{CLEAR_TO 0x4E}33BP"),
        COMPOUND_STRING("ICE PUNCH{CLEAR_TO 0x4E}33BP"),
        COMPOUND_STRING("THUNDERPUNCH{CLEAR_TO 0x4E}33BP"),
        COMPOUND_STRING("FIRE PUNCH{CLEAR_TO 0x4E}33BP"),
        gText_Exit
    },
